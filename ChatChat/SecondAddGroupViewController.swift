//
//  SecondAddGroupViewController.swift
//  
//
...
class SecondAddGroupViewController: UIViewController,UISearchBarDelegate, UISearchResultsUpdating, UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        retrieveAllUsers()        // Do any additional setup after loading the view.
    }
